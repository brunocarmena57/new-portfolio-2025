...
export const Header = ({ isFullscreen, toggleFullscreen, ...props }: HeaderProps) => {
  return (
    ...
    >
      ...
      <p className='mx-auto select-none font-semibold not-sr-only hidden lg:block'>Bruno</p>
      <p className='mx-auto select-none font-semibold not-sr-only lg:hidden block'>Carmena</p>
      <LennyFace />
    </header>
  )
}
